...
const FAQS = [
  ...
  },
  {
    ...
    a: "Weil bei KBS Gründer ans Telefon gehen, die KI täglich selbst einsetzen, im Schnitt mehr als zehn Stunden pro Tag. Fynn-Luca Schulz und Julian Stosse führen neben KBS das Webdesign-Studio Fylu Marketing in Saarlouis und entwickeln die SaaS-Plattform Taskey für Gebäudereinigungsbetriebe. Bei KBS bekommen Sie deshalb keine Theorie, sondern gelebte KI-Praxis."
  }
];

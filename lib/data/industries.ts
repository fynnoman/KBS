...
export const INDUSTRIES: Industry[] = [
  ...
  },
  {
    ...
    tag: "KI im Einzelhandel",
    headline: "KI im inhabergeführten Einzelhandel.",
    headlineSecondary: "Kundenkommunikation, Produktbeschreibungen und Marketing schneller.",
    intro:
      "Inhabergeführte Einzelhändler haben selten die IT-Ressourcen großer Handelsketten – aber ähnliche Herausforderungen: Produktbeschreibungen, Kundenanfragen, Marketing, Social Media, Newsletter. Generative KI ist genau in diesen Text- und Kommunikationsfeldern schnell wirksam, ohne dass Kassensystem oder Warenwirtschaft angefasst werden müssen.",
    processes: [
      "Produktbeschreibungen für Onlineshop und Marktplätze",
      "Kundenanfragen per E-Mail, Instagram, Facebook",
      "Newsletter und Kundenmailings",
      "Social-Media-Posts und Content-Planung",
      "Preisverhandlungen mit Lieferanten (Textvorbereitung)",
      "Interne Anweisungen für Aushilfen und Neuaushilfen"
    ],
    useCases: [
      {
        title: "Produktbeschreibung in Marken-Tonalität",
        description:
          "Aus Basisdaten (Produktname, Kategorie, Materialien, Größen) entsteht eine erste Beschreibung in Ihrem Stil. Sie prüfen die Fakten, ergänzen Alleinstellungen, veröffentlichen. Statt eine Stunde pro Produkt zu texten, dauert der Prozess wenige Minuten."
      },
      {
        title: "Kundenanfragen auf allen Kanälen",
        description:
          "Ob DM auf Instagram, E-Mail oder Kontaktformular – KI hilft dabei, wiederkehrende Fragen (Öffnungszeiten, Verfügbarkeit, Reservierung) mit Antwortentwürfen abzudecken. Sie prüfen und senden, statt jede Antwort neu zu formulieren."
      },
      {
        title: "Wochen-Newsletter ohne Redaktionsstress",
        description:
          "Aus einer kurzen Notiz zu Themen der Woche (neue Ware, Aktion, Öffnungszeiten) entsteht ein fertiger Newsletter-Entwurf. Sie lesen quer, klicken senden. Der Aufwand für regelmäßige Kundenkommunikation halbiert sich mindestens."
      }
    ],
    tools: [
      "Text-KI in Business-Variante",
      "Bild-KI für Produkt-Zusatzbilder (mit klaren Nutzungsrechten)",
      "Optional: Anbindung an Ihren Shop / Ihre Warenwirtschaft für Produkt-Batches",
      "Social-Media-Planungstools mit KI-Integration"
    ],
    risks: [
      "Angaben zu Preisen, Verfügbarkeit und Materialien müssen faktisch korrekt sein – KI erfindet gelegentlich Details",
      "Kundendaten aus Anfragen gehören in geprüfte Systeme, nicht ins offene Web-Tool",
      "Werbeaussagen unterliegen dem Wettbewerbsrecht – KI-Output muss auf irreführende Angaben geprüft werden",
      "Marken- und Bildrechte auf Marktplätzen sind je Plattform unterschiedlich – KI-Bilder brauchen klare Freigabe"
    ],
    priorities: [
      "Starten Sie mit Produktbeschreibungen – schneller Zeitgewinn, direkter Sichtbarkeits-Effekt",
      "Dann Newsletter- und Social-Content – regelmäßiger Kundenkontakt ohne Redaktionsstress",
      "Erst danach Kundenanfragen-Bearbeitung, wenn die Freigabekette sauber definiert ist"
    ],
    relatedCourseSlugs: ["ki-anwender", "marketing", "kundenservice"],
    faqs: [
      {
        q: "Lohnt sich KI für einen kleinen Laden mit ein bis drei Mitarbeitenden?",
        a: "Ja, häufig sogar besonders. Kleine Läden haben selten dedizierte Marketing-Kräfte. Der Inhaber macht alles selbst – Wareneinkauf, Verkauf, Buchhaltung, Marketing. Genau dort entlastet KI, weil die Marketing-Textarbeit von Stunden auf Minuten fällt."
      },
      {
        q: "Ersetzt KI meine persönliche Ansprache im Laden?",
        a: "Nein, im Gegenteil. Persönliche Beratung im Laden ist der Kernvorteil des inhabergeführten Einzelhandels gegenüber Online-Ketten. KI erledigt den Schreibtisch-Teil, sodass Sie mehr Zeit für die Kundinnen und Kunden vor Ihnen haben."
      },
      {
        q: "Brauche ich eine eigene Software?",
        a: "In den meisten Fällen nicht. Business-Varianten bekannter KI-Anbieter reichen für Text- und Bild-Arbeit vollkommen aus. Erst wenn Sie Produktkataloge im großen Umfang automatisch generieren wollen, wird eine Integration in Ihre Warenwirtschaft interessant."
      }
    ],
    keywords: [
      "KI Einzelhandel",
      "KI Onlineshop",
      "Produktbeschreibung KI",
      "ChatGPT Einzelhandel",
      "KI kleiner Laden"
    ]
  },
  {
    ...
    tag: "KI in der Gastronomie",
    headline: "KI in der Gastronomie.",
    headlineSecondary: "Kommunikation, Speisekarten und Marketing – ohne Aufwand für den Wirt.",
    intro:
      "Gastronomiebetriebe haben meist wenig Zeit für Bürothemen. Der Kernbetrieb frisst den Tag, und was liegen bleibt, wird abends nebenher gemacht. Generative KI kann genau hier ansetzen: Reservierungs-Antworten, Speisekarten-Beschreibungen, Social-Media-Posts, Bewertungsantworten. Kein Ersatz für die Küche und den Service, aber deutliche Entlastung im Büro.",
    processes: [
      "Reservierungsanfragen per E-Mail und Social Media",
      "Speisekarten- und Wein-Beschreibungen",
      "Bewertungsantworten (positiv wie negativ)",
      "Social-Media-Planung",
      "Interne Anweisungen für neue Aushilfen",
      "Newsletter und Stammkunden-Kommunikation"
    ],
    useCases: [
      {
        title: "Reservierungsanfragen zuverlässig beantworten",
        description:
          "Anfragen per E-Mail oder Instagram werden per KI-Vorlage strukturiert beantwortet. Verfügbarkeit prüfen Sie im Reservierungssystem, KI übernimmt Text, Freundlichkeit und Format. Weniger vergessene Anfragen, freundlicherer Ton auch abends."
      },
      {
        title: "Speisekarten- und Weinbeschreibungen",
        description:
          "Aus Zutaten- oder Weinlisten entstehen appetitliche Kurzbeschreibungen in Ihrem Stil. Ideal für Wochenkarten, Tagesempfehlungen oder saisonale Menüs, die sonst schnell aus Zeitmangel weggelassen werden."
      },
      {
        title: "Bewertungen professionell beantworten",
        description:
          "Ob positiv oder kritisch – Bewertungen bei Google, TripAdvisor oder auf Social Media verdienen eine Antwort. KI liefert einen ersten Entwurf im richtigen Ton, Sie prüfen und veröffentlichen. Konsequente Bewertungsantworten wirken vertrauensbildend."
      }
    ],
    tools: [
      "Text-KI in Business-Variante (Kundendaten schützen)",
      "Bild-KI für Speisen-Illustrationen (nur mit klarer Kennzeichnung, wenn es nicht die tatsächliche Präsentation ist)",
      "Social-Media-Planungstools",
      "Optional: Anbindung an Reservierungssoftware"
    ],
    risks: [
      "Angaben zu Allergenen und Zutaten müssen faktisch korrekt sein – hier ist die Küche die Quelle, nicht die KI",
      "Kundendaten aus Reservierungen sollten nicht in offene Chatbots",
      "Bewertungsantworten müssen den plattformspezifischen Regeln entsprechen",
      "Falsche Bilddarstellungen (z. B. KI-Bild statt echtem Gericht ohne Kennzeichnung) können als irreführend gelten"
    ],
    priorities: [
      "Starten Sie mit Speisekarten- und Wochenkarten-Texten – schneller Effekt, kein Rechtsrisiko",
      "Dann Bewertungsantworten – regelmäßig, freundlich, ohne Textblock aus dem Standard",
      "Erst danach Reservierungs-Automation – prüfen Sie die Anbindung an Ihre Reservierungssoftware"
    ],
    relatedCourseSlugs: ["ki-anwender", "marketing", "kundenservice"],
    faqs: [
      {
        q: "Lohnt sich KI für einen Familienbetrieb?",
        a: "Ja, oft besonders. In Familienbetrieben macht der Wirt oder die Wirtin die gesamte Bürokommunikation selbst – neben Küche und Service. Jede Stunde, die dabei gespart wird, ist wertvolle Zeit im Betrieb oder mit der Familie."
      },
      {
        q: "Kann KI Speisekarten übersetzen?",
        a: "Ja, mit Einschränkungen. Für die grundsätzliche Übersetzung ins Englische oder Französische liefert KI meist gute Ergebnisse. Fachbegriffe (regionale Spezialitäten, Weinbau-Termini) sollten immer geprüft werden. Bei komplett kartenübergreifenden Übersetzungen empfiehlt sich zusätzlich ein muttersprachliches Lektorat."
      },
      {
        q: "Sind KI-Bilder von Gerichten erlaubt?",
        a: "Rechtlich zulässig, aber heikel. Wenn ein KI-Bild wie eine Fotografie eines tatsächlichen Gerichts wirkt, obwohl das reale Gericht anders aussieht, kann das irreführend sein. Wir empfehlen KI-Bilder nur für Stimmungs-Illustrationen mit klarer Kennzeichnung, echte Gerichte fotografiert man."
      }
    ],
    keywords: [
      "KI Gastronomie",
      "KI Restaurant",
      "Speisekarte KI",
      "Bewertungen beantworten KI",
      "Gastro Digitalisierung"
    ]
  },
  {
    slug: "produktion",
  ...
  {
    slug: "vereine",
    name: "Vereine & Organisationen",
    displayName: "Vereine",
    tag: "KI für Vereine",
    headline: "KI für Vereine und Organisationen.",
    headlineSecondary: "Ehrenamt entlasten, ohne den Charakter zu verlieren.",
    intro:
      "Vereine und gemeinnützige Organisationen leben von Ehrenamt. Das begrenzt die Zeit für Verwaltung, Kommunikation und Öffentlichkeitsarbeit – und genau dort kann generative KI helfen. Sie ersetzt kein persönliches Engagement, aber sie hebt einen erheblichen Teil der Textarbeit vom Schreibtisch der ehrenamtlich Aktiven.",
    processes: [
      "Vereinsmails, Rundschreiben, Terminankündigungen",
      "Presse- und Öffentlichkeitsarbeit",
      "Anträge auf Förderung und Zuschüsse (Textentwürfe)",
      "Protokolle von Sitzungen und Versammlungen",
      "Beitragsverwaltung und Mitgliederkommunikation (Textseite)",
      "Website- und Social-Media-Pflege"
    ],
    useCases: [
      {
        title: "Sitzungsprotokoll aus Notizen",
        description:
          "Nach der Vorstandssitzung diktiert oder tippt jemand die Kernpunkte. KI erstellt daraus ein sauberes Protokoll in Ihrem Vereinsformat. Der Schriftführer prüft und gibt frei – Aufwand fällt von Stunden auf wenige Minuten."
      },
      {
        title: "Förderantrag als Textentwurf",
        description:
          "Aus einer Projektbeschreibung entstehen erste Textbausteine für den Förderantrag: Ausgangslage, Ziel, Wirkung, Zeitplan. Das Ehrenamt profitiert von einer strukturierten Basis, die inhaltliche Arbeit bleibt aber beim Verein."
      },
      {
        title: "Regelmäßige Vereinsnachrichten",
        description:
          "Termine, Berichte, Aufrufe: KI hilft dabei, aus einer Notizsammlung einen fertigen Newsletter oder eine Vereinszeitschrift-Seite zu formen. Die Konsistenz und Regelmäßigkeit von Mitgliederkommunikation steigt spürbar."
      }
    ],
    tools: [
      "Text-KI in Business-Variante (bei Mitgliederdaten wichtig)",
      "Optional: einfache lokale KI für besonders sensible Daten",
      "Sprach-zu-Text für Sitzungen und Berichte",
      "Newsletter- und Social-Media-Tools mit KI-Integration"
    ],
    risks: [
      "Mitgliederdaten unterliegen der DSGVO – nicht in offene Chatbots",
      "Bei Wahlprotokollen und Beschlüssen bleibt die formale Korrektheit beim Menschen",
      "Öffentliche Kommunikation muss faktisch korrekt sein, gerade bei Fördermitteln und Statistiken",
      "Ehrenamts-Ressourcen für KI-Einführung sind begrenzt – Umfang klein halten"
    ],
    priorities: [
      "Starten Sie mit Protokollen und Rundschreiben – hoher Nutzen, niedriges Risiko",
      "Dann Öffentlichkeitsarbeit und Social Media",
      "Anträge und Verwaltung erst, wenn eine ehrenamtlich verantwortliche Person klar zuständig ist"
    ],
    relatedCourseSlugs: ["ki-anwender", "prompt-engineering"],
    faqs: [
      {
        q: "Können ehrenamtlich geführte Vereine sich das leisten?",
        a: "Häufig ja. Business-Zugänge zu KI-Werkzeugen liegen im Bereich üblicher Vereins-Software-Kosten. Für ganz kleine Vereine reicht oft ein einzelner Account, den das Vorstandsteam gemeinsam nutzt. Wir zeigen im Erstgespräch, wo die realistische Kostenschwelle liegt."
      },
      {
        q: "Braucht der Verein dafür eine Schulung?",
        a: "Eine kurze Einführung reicht in den meisten Fällen. Wir bieten Vereinen ein reduziertes Format an, das die Kernpunkte in ein paar Stunden vermittelt. Ziel ist Selbstständigkeit, nicht Abhängigkeit von externer Beratung."
      },
      {
        q: "Ändert KI den Charakter unserer Vereinskommunikation?",
        a: "Nur wenn Sie es zulassen. KI liefert Entwürfe, die verantwortliche Person entscheidet über Ton und Form. Vereine, die auf persönlichen Charakter Wert legen, sollten KI eher als Ideen- und Struktur-Helfer nutzen, nicht als Autor. Der Unterschied bleibt spürbar."
      }
    ],
    keywords: [
      "KI Verein",
      "KI Ehrenamt",
      "KI gemeinnützige Organisation",
      "Vereinsverwaltung KI",
